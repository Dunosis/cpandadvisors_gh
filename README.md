...
A static website for Claudia Principal & Associates, an accounting firm in St. Louis specializing in personalized tax and accounting services for the Latino community. This project is designed for simplicity, performance, and easy deployment using GitHub Pages.
...
```bash
  git clone https://github.com/your-username/cpandadvisors_gh.git
  cd cpandadvisors_gh
```
...
3. **Check deployment status:**
   ...
   - Once successful, your site will be available at:
     - `https://[your-username].github.io/cpandadvisors_gh/`
     - Or `https://[your-org].github.io/cpandadvisors_gh/` if it's an organization repository
...
- **Google Fonts (Montserrat)** - Web typography
- **Normalize.css** - CSS reset for cross-browser consistency
- **OpenWidget** - Customer communication widget
